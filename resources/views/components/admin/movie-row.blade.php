...
<tr class="@if($is_odd) bg-indigo-50 @endif">
    ...
    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
        <a href="/movies/{{ $movie->slug }}" class="text-indigo-600 hover:text-indigo-900">View Movie</a>
    </td>
    ...
    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
        <a href="/admin/movies/{{ $movie->slug }}/edit" class="text-indigo-600 hover:text-indigo-900">Edit</a>
    </td>
